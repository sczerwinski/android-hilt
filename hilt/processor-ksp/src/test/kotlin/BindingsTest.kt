...
@DisplayName("Tests for bindings modules generated with KSP")
class BindingsTest {
    ...
    @DisplayName(
        value = "GIVEN interface with bindings for different scopes and qualifiers, " +
            "WHEN generate bindings modules, " +
            "THEN generated singleton component module should contain bindings for all singleton implementations"
    )
    ...
    @DisplayName(
        value = "GIVEN interface with bindings for different scopes and qualifiers, " +
                "WHEN generate bindings modules, " +
                "THEN generated custom component module should contain bindings for all custom implementations"
    )
    fun customComponentBindingsModule() {
        val module = mockk<Repository_CustomComponent_BindingsModule>()
